    ...
    var chart = new CanvasJS.Chart("chartContainer", {
        ...
        data: [{        
            ...
            dataPoints: [      
                ...
                { y: 10,  label: "IoT", cursor: "pointer", name: "IoT", description: "In this four months module, the following topics were practically and theoretically covered:<br><br>» What is IoT?<br>» Distributed systems.<br>» Virtualization.<br>» Cloud computing.<br>» Smart objects.<br>» NFC.<br>» RFID.<br>» Arduino.<br>» Sensor networks."},
